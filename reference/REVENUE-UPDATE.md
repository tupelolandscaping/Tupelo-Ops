...
6. Review `git diff` on `model/data/revenue-invoices.csv` and `model/data/revenue-line-items.csv`. This diff *is* the period's revenue report — new invoices, and any edits Homeworks silently made to prior ones.
7. Commit.
